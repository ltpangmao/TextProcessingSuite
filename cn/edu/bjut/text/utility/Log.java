...
public class Log {
	...
	/**
	 * The level of messages that will be logged. Compiling this and the booleans below as "final" will cause the compiler to remove all "if (Log.info) ..." type statements below
	 * the set level.
	 */
